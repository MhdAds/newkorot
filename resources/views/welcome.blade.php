        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1 style="font-weight: 800; font-size: 40px; color: #5c5c5c">{{ $Settings->name }}</h1>
                </div>
                <p style="margin-top: -15px; margin-left: 209px; font-size: 11px;"><span>Devest</span></p>
                <a href="/dashboard/login" class="btn btn-relief-primary flex justify-center">Login To Dashboard</a>
