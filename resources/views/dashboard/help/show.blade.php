    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dashboard.help.update', $Help->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $Help->created_at }}" id="created-at" disabled />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="@if ($Help->status == 0) جديد @elseif ($Help->status == 1) تم المشاهدة  @elseif ($Help->status == 2) مقبول  @elseif ($Help->status == 3) تم التحويل @elseif ($Help->status == 6) مرفوض  @endif" id="status" disabled />
                                </div>
                            </div>
                            
                            @if ($Help->status == 1 || $Help->status == 2)
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="status">تحديث حالة الطلب</label>
                                        <select class="form-control" name="status" id="status">
                                            <option value="1" @if ($Help->status == 1) selected @endif readonly>تم المشاهدة</option>
                                            <option value="2" @if ($Help->status == 2) selected @endif>الطلب مقبول</option>
                                            <option value="3" @if ($Help->status == 3) selected @endif>تم التحويل</option>
                                            <option value="6" @if ($Help->status == 6) selected @endif>مرفوض</option>
                                        </select>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $Help->value }}" id="created-at" disabled />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="staff-notes" name="staff_notes" rows="3" @if ($Help->status == 3 || $Help->status == 6) disabled @endif>{{ $Help->staff_notes }}</textarea>
                                </div>
                            </div>
