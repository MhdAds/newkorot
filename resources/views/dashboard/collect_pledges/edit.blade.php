        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">العهود / تعديل</h4>
                    
                </div>
                <div class="card-body">
                    <form action="{{ route('dashboard.collect-pledges.update', $Pledge->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <select class="form-control" name="user_id" id="user-id" required>
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{$user->id}}" @if ($Pledge->user->user_id == $user->id) selected @endif>{{$user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="number" name="value" value="{{ $Pledge->value }}" id="edit-total-payments" class="form-control">
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-md-6 col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="payment_date" value="{{$Pledge->payment_date}}" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" />
                                </div>
                            </div> --}}
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" name="notes" id="notes" rows="4">{{$Pledge->notes}}</textarea>
                                </div>
                            </div>
