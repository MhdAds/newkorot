    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dashboard.compensation.update', $Compensation->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="number" name="value" value="{{ $Compensation->value }}" id="edit-total-payments" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" name="notes" id="notes" rows="4">{{$Compensation->notes}}</textarea>
                                </div>
                            </div>
