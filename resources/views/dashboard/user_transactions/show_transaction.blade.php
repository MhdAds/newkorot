    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dashboard.user-transactions.update', $Transaction->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $Transaction->created_at }}" id="created-at" disabled />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="@if ($Transaction->status == 0) جديد @elseif ($Transaction->status == 1) تم المشاهدة  @elseif ($Transaction->status == 2) مقبول  @elseif ($Transaction->status == 3) تم التحويل @elseif ($Transaction->status == 6) مرفوض  @endif" id="status" disabled />
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status">
                                            <option value="1" @if ($Transaction->status == 1) selected @endif readonly>تم المشاهدة</option>
                                            <option value="2" @if ($Transaction->status == 2) selected @endif>الطلب مقبول</option>
                                            <option value="3" @if ($Transaction->status == 3) selected @endif>تم التحويل</option>
                                            <option value="6" @if ($Transaction->status == 6) selected @endif>مرفوض</option>
                                        </select>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $Transaction->value }}" id="created-at" disabled />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="staff-notes" name="staff_notes" rows="3" @if ($Transaction->status == 3 || $Transaction->status == 6) disabled @endif>{{ $Transaction->staff_notes }}</textarea>
                                </div>
                            </div>
