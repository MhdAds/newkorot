        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">المديونيات / اضافة</h4>
                </div>
                <div class="card-body">
                   
                    <!-- Form -->
                    <form action="{{ route('dashboard.collect-indebtedness.store') }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="number" name="value" value="{{ old('value') }}" id="edit-total-payments" class="form-control">
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-md-6 col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="payment_date" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" />
                                </div>
                            </div> --}}
