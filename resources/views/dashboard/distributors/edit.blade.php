        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                    ...
                    <form action="{{ route('dashboard.distributors.update', $Distributor->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="media mb-2">
                                    <img src="{{ image_or_placeholder($Distributor->avatar_full_path, 'profile') }}" alt="users avatar"
                                    ...
                                    <div class="media-body mt-50">
                                        ...
                                        <div class="col-12 d-flex mt-1 px-0">
                                            ...
                                            @if ($Distributor->avatar() != null)
                                                <a href="{{ route('dashboard.common.image-delete', $Distributor->avatar()->id) }}" class="btn btn-outline-secondary d-none d-sm-block">Remove</a>
                                            @endif
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <select class="form-control" name="supervisor_id" id="supervisor-id" required>
                                    ...
                                    @foreach ($all_staff as $staff)
                                        <option value="{{$staff->id}}" @if($staff->id == $Distributor->supervisor_id) selected @endif>{{$staff->name}}</option>
                                    @endforeach                                 
                                </select>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name" value="{{ $Distributor->name }}" name="name" id="name" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="email">البريد الالكتروني</label>
                                    <input type="email" class="form-control" placeholder="Email" value="{{ $Distributor->email }}" name="email" id="email" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="phone">رقم الهاتف</label>
                                    <input type="tel" class="form-control" placeholder="Phone" value="{{ $Distributor->phone }}" name="phone" id="phone" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status" id="status">
                                        <option value="1" @if ($Distributor->status == 1) selected @endif>Active</option>
                                        <option value="0" @if ($Distributor->status == 0) selected @endif>Deactivated</option>
                                        <option value="6" @if ($Distributor->status == 6) selected @endif>Blocked</option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="tab-pane" id="information" aria-labelledby="information-tab"
                    ...
                    <form action="{{ route('dashboard.Distributor.update-info', $Distributor->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        <div class="row mt-1">
                            <div class="col-12">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control birthdate-picker" name="birth_date" value="{{$Distributor->birth_date}}" id="birth" placeholder="YYYY-MM-DD" />
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="male" name="gender" value="1" @if ($Distributor->gender == 1) checked @endif class="custom-control-input" />
                                        <label class="custom-control-label" for="male">Male</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="female" name="gender" value="0" @if ($Distributor->gender == 0) checked @endif class="custom-control-input"/>
                            ...
                            <div class="col-md-4 col-6">
                                ...
                                <select class="form-control" name="governorate_id" required>
                                    ...
                                    @foreach ($governorates as $governorate)
                                        <option value="{{$governorate->id}}" @if (isset($Distributor->governorate) && $Distributor->governorate->id == $governorate->id) selected @endif>{{$governorate->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 col-6">
                                ...
                                <select class="form-control" name="city_id" required>
                                    ...
                                    @foreach ($cities as $city)
                                        <option value="{{$city->id}}" @if (isset($Distributor->city) && $Distributor->city->id == $city->id) selected @endif>{{$city->name}}</option>
                                    @endforeach
                                </select>
                                {{-- <div class="valid-feedback">Looks good!</div>
                                <div class="invalid-feedback">Please select your country</div> --}}
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address_line_1" value="{{ $Distributor->address_line_1 }}" class="form-control" id="address-1" />
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label for="address-2">Address Line 2</label>
                                    <input type="text" name="address_line_2" value="{{ $Distributor->address_line_2 }}" class="form-control" id="address-2" />
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="form-modal-ex">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('dashboard.plans.copy-plans') }}" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="copy_Distributor_id" placeholder="Enter plan id" class="form-control" required>
                                            </div>
                        ...
                        <a href="{{ route('dashboard.plans.create', $Distributor->id) }}" class="btn btn-gradient-success">Add New</a>
                    </div>
                </div>
                <div class="card-datatable">
                    <table class="dt-multilingual table">
                        ...
                        <tbody>
                            @foreach ($Distributor->plans()->orderBy('month', 'desc')->take(12)->get(); as $index => $plan)
                                <tr>
                                    <td>{{ $plan->id }}</td>
                                    <td>{{ $plan->month }}</td>
