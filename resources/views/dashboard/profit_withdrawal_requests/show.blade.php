    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dashboard.profit-withdrawal-requests.update', $ProfitWithdrawalRequest->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $ProfitWithdrawalRequest->created_at }}" id="created-at" disabled />
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="@if ($ProfitWithdrawalRequest->status == 0) جديد @elseif ($ProfitWithdrawalRequest->status == 1) تم المشاهدة  @elseif ($ProfitWithdrawalRequest->status == 2) مقبول  @elseif ($ProfitWithdrawalRequest->status == 3) تم التحويل @elseif ($ProfitWithdrawalRequest->status == 6) مرفوض  @endif" id="status" disabled />
                                </div>
                            </div>
                            
                            @if ($ProfitWithdrawalRequest->status == 1 || $ProfitWithdrawalRequest->status == 2)
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="status">تحديث حالة الطلب</label>
                                        <select class="form-control" name="status" id="status">
                                            <option value="1" @if ($ProfitWithdrawalRequest->status == 1) selected @endif readonly>تم المشاهدة</option>
                                            <option value="2" @if ($ProfitWithdrawalRequest->status == 2) selected @endif>الطلب مقبول</option>
                                            <option value="3" @if ($ProfitWithdrawalRequest->status == 3) selected @endif>تم التحويل</option>
                                            <option value="6" @if ($ProfitWithdrawalRequest->status == 6) selected @endif>مرفوض</option>
                                        </select>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" value="{{ $ProfitWithdrawalRequest->value }}" id="created-at" disabled />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="staff-notes" name="staff_notes" rows="3" @if ($ProfitWithdrawalRequest->status == 3 || $ProfitWithdrawalRequest->status == 6) disabled @endif>{{ $ProfitWithdrawalRequest->staff_notes }}</textarea>
                                </div>
                            </div>
