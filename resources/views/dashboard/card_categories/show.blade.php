        ...
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                {{-- <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.representatives.show', $CardCategory->user_id) }}">{{$CardCategory->representative->name}}</a>
                    </li>
                    <li class="breadcrumb-item active">CardCategory: #{{$CardCategory->id}} / Show
                    </li>
                </ol> --}}
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">الفئات / عرض</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <input type="text" name="name" value="{{ $CardCategory->name }}" class="form-control" id="name" disabled />
                        </div>
                        

                        <div class="col-md-6 col-12">
                            <label for="rank">الترتيب</label>
                            <input type="number" name="rank" value="{{ $CardCategory->rank }}" class="form-control" id="rank" disabled />
                        </div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div id="blog-editor-wrapper">
                                    <div id="blog-editor-container">
                                        <textarea name="description" class="form-control" id="editor1" disabled>{{ $CardCategory->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
