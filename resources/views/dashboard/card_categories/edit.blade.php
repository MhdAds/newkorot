        ...
        <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
                {{-- <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.representatives.edit', $CardCategory->user_id) }}">{{$CardCategory->representative->name}}</a>
                    </li>
                    <li class="breadcrumb-item active">CardCategory: #{{$CardCategory->id}} / Edit
                    </li>
                </ol> --}}
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">الفئات / تعديل</h4>
                </div>
                <div class="card-body">
                   
                    <!-- Form -->
                    <form action="{{ route('dashboard.card-categories.update', $CardCategory->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <input type="text" name="name" value="{{ $CardCategory->name }}" class="form-control" id="name" required />
                            </div>
                            

                            <div class="col-md-6 col-12">
                                <label for="rank">الترتيب</label>
                                <input type="number" name="rank" value="{{ $CardCategory->rank }}" class="form-control" id="rank" required />
                            </div>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div id="blog-editor-wrapper">
                                        <div id="blog-editor-container">
                                            <textarea name="description" class="form-control" id="editor1">{{ $CardCategory->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
