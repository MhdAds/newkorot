    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                ...
                <form method="POST" action="{{ route('dashboard.merchants.store') }}" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                            <button type="submit" class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">اضافة</button>
                        </div>
                    </div>
                </form>
