        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <form action="{{ route('dashboard.merchant-packages.store') }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        <div class="row">
                            
                            <div class="col-md-12 col-12">
                                <div class="form-group mb-2">
                                    <label for="blog-edit-name">اسم الباقة</label>
                                    <input type="text" name="name" value="{{ old('name') }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="border rounded p-2">
                                    <h4 class="mb-1">الايكونة</h4>
