    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dashboard.merchant-packages.update', $MerchantPackage->id) }}" method="post" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ $MerchantPackage->name }}" />
                                </div>
                            </div>
                                            ...
                                            <div class="d-inline-block">
                                                <div class="form-group mb-0">
                                                    <div class="custom-file">
                                                        <input type="file" name="icon" class="custom-file-input" id="blogCustomFile" accept="image/*" />
                            ...
                            <div class="col-12 mt-50">
                                <button type="submit" class="btn btn-primary mr-1">حفظ التغير</button>
