        ...
        <div class="col-lg-12 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">اعدادات تطبيق التاجر</h4>
                </div>
                <div class="card-body">
                   
                    <!-- Form -->
                    <form method="POST" action="{{ route('dashboard.settings.merchants-app.update') }}" enctype="multipart/form-data" class="form form-vertical">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group mb-2">
                                    <label for="merchants-latest-version">احدث نسخة</label>
                                    <input type="text" name="merchants_latest_version" class="form-control" value="{{ $settings->merchants_latest_version }}" />
                                </div>
                            </div>
