        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title">المديونات / تعديل</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="number" name="value" value="{{ $Indebtedness->value }}" id="edit-total-payments" class="form-control" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" name="notes" id="notes" rows="4" disabled>{{$Indebtedness->notes}}</textarea>
                                </div>
                            </div>
