...
class SettingsController extends Controller
{
    ...
    public function smtp_update(Request $r)
    {
        ...
        $Settings->smtp_host = $r->smtp_host;
        $Settings->smtp_port = $r->smtp_port;
        $Settings->smtp_encryption = $r->smtp_encryption;
        $Settings->smtp_username = $r->smtp_username;
        $Settings->smtp_password = $r->smtp_password;
        $Settings->smtp_from_address = $r->smtp_from_address;
        $Settings->smtp_from_name = $r->smtp_from_name;
